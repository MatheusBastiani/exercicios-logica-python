...
peso = float(input('Insira quantos quilos de peixo Joao pescou'))
...
print(f'Joao pescou {excesso} quilos a mais do que o permitido')
print(f'Joao deve pagar {multa} reais de multa')
